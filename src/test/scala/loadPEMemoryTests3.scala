...
class LoadPEMemorySpec3 extends AnyFlatSpec with ChiselScalatestTester{
...
//Inputs
	    ...
	    dut.io.load_pe_memory_in.loading_layer.poke(3.U(16.W))
	    dut.io.load_pe_memory_in.loading_activations(0).poke(5.U(16.W))
	    dut.io.load_pe_memory_in.loading_activations(1).poke(6.U(16.W))
	    dut.io.load_pe_memory_in.loading_activations(2).poke(7.U(16.W))
	    dut.io.load_pe_memory_in.loading_activations(3).poke(8.U(16.W))
	    ...
	    dut.io.load_pe_memory_in.write_memoryUnits(3).poke(0.U(2.W))
	    dut.io.load_pe_memory_in.weight_buffer_load_request.poke(true.B)
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.interconnect_loading_layer.expect(3.U(16.W))
	    dut.io.load_pe_memory_out.interconnect_loading_activation.expect(5.U(16.W))
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(0.U(16.W))
    	    ...
    	    dut.io.load_pe_memory_out.write_memoryUnits(0).expect(1.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(1).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(2).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(3).expect(0.U(2.W))
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.interconnect_loading_layer.expect(3.U(16.W))
	    dut.io.load_pe_memory_out.interconnect_loading_activation.expect(6.U(16.W))
	    dut.io.load_pe_memory_out.interconnect_load_request.expect(true.B)
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(0.U(16.W))
    	    ...
    	    dut.io.load_pe_memory_out.write_memoryUnits(0).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(1).expect(1.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(2).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(3).expect(0.U(2.W))
	    dut.io.load_pe_memory_out.weight_buffer_memory_write_data.expect(0.U(16.W))
	    dut.io.load_pe_memory_out.weight_buffer_memory_write_address.expect(0.U(16.W))
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.interconnect_loading_layer.expect(3.U(16.W))
	    dut.io.load_pe_memory_out.interconnect_loading_activation.expect(7.U(16.W))
	    dut.io.load_pe_memory_out.interconnect_load_request.expect(true.B)
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(0.U(16.W))
    	    ...
    	    dut.io.load_pe_memory_out.write_memoryUnits(0).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(1).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(2).expect(1.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(3).expect(0.U(2.W))
	    dut.io.load_pe_memory_out.weight_buffer_memory_write_data.expect(0.U(16.W))
	    dut.io.load_pe_memory_out.weight_buffer_memory_write_address.expect(0.U(16.W))
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.load_initial_weights_complete.expect(false.B)   
	    dut.io.load_pe_memory_out.load_datapoint_complete.expect(false.B)
	    dut.io.load_pe_memory_out.load_buffer_weight_memory_complete.expect(true.B)
