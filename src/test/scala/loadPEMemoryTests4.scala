...
class LoadPEMemorySpec4 extends AnyFlatSpec with ChiselScalatestTester{
...
//Outputs
	    ...
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(0.U(16.W))
    	    ...
    	    dut.io.load_pe_memory_out.write_memoryUnits(0).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(1).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(2).expect(0.U(2.W))
    	    dut.io.load_pe_memory_out.write_memoryUnits(3).expect(0.U(2.W))
...
//Inputs
            dut.io.load_pe_memory_in.load_datapoint.poke(true.B)
            dut.io.load_pe_memory_in.load_same_data.poke(true.B)
...
//Outputs	    
	    ...
	    dut.io.load_pe_memory_out.load_initial_weights_complete.expect(false.B)   
	    dut.io.load_pe_memory_out.load_datapoint_complete.expect(true.B)
	    dut.io.load_pe_memory_out.load_buffer_weight_memory_complete.expect(false.B)
...
//Inputs
            ...
            dut.io.load_pe_memory_in.load_datapoint.poke(true.B)
            dut.io.load_pe_memory_in.load_new_request.poke(false.B)
            dut.io.load_pe_memory_in.load_data_from_buffer.poke(true.B)
            dut.io.load_pe_memory_in.load_same_data.poke(false.B)
...
//Outputs
	    ...
	    dut.io.load_pe_memory_out.current_load_datapoint_state.expect(0.U(16.W))
    	    dut.io.load_pe_memory_out.current_load_weights_state.expect(0.U(16.W))
...
//Outputs
	    dut.io.load_pe_memory_out.current_load_datapoint_state.expect(1.U(16.W))
    	    dut.io.load_pe_memory_out.current_load_weights_state.expect(0.U(16.W))

	    dut.io.load_pe_memory_out.load_initial_weights_complete.expect(false.B)   
	    dut.io.load_pe_memory_out.load_datapoint_complete.expect(false.B)
	    dut.io.load_pe_memory_out.load_buffer_weight_memory_complete.expect(false.B)
    	    dut.io.load_pe_memory_out.load_new_data_request.expect(false.B)
    	    

	    dut.io.load_pe_memory_out.datapoint_memory_write_enable.expect(true.B)
	    dut.io.load_pe_memory_out.datapoint_memory_write_data.expect(0.U(16.W))
	    dut.io.load_pe_memory_out.datapoint_memory_write_address.expect(0.U(16.W))
	    ...
	    dut.io.load_pe_memory_in.buffer_memory_output.poke(1.U(16.W))
	    dut.io.load_pe_memory_in.interconnect_memory_output.poke(0.U(16.W))
...
//Outputs
	    ...
	    dut.io.load_pe_memory_out.datapoint_memory_write_enable.expect(true.B)
	    dut.io.load_pe_memory_out.datapoint_memory_write_data.expect(1.U(16.W))
	    dut.io.load_pe_memory_out.datapoint_memory_write_address.expect(0.U(16.W))
    
	    dut.io.load_pe_memory_out.buffer_memory_write_enable.expect(false.B)
	    dut.io.load_pe_memory_out.buffer_memory_write_data.expect(0.U(16.W))
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(1.U(16.W))
	    ...
	    dut.io.load_pe_memory_in.buffer_memory_output.poke(2.U(16.W))
	    dut.io.load_pe_memory_in.interconnect_memory_output.poke(0.U(16.W))
...
//Outputs
	    ...
	    dut.io.load_pe_memory_out.datapoint_memory_write_enable.expect(true.B)
	    dut.io.load_pe_memory_out.datapoint_memory_write_data.expect(2.U(16.W))
	    dut.io.load_pe_memory_out.datapoint_memory_write_address.expect(1.U(16.W))
    
	    dut.io.load_pe_memory_out.buffer_memory_write_enable.expect(false.B)
	    dut.io.load_pe_memory_out.buffer_memory_write_data.expect(0.U(16.W))
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(2.U(16.W))
	    ...
	    dut.io.load_pe_memory_in.buffer_memory_output.poke(3.U(16.W))
	    dut.io.load_pe_memory_in.interconnect_memory_output.poke(0.U(16.W))
...
//Outputs
	    ...
	    dut.io.load_pe_memory_out.datapoint_memory_write_enable.expect(true.B)
	    dut.io.load_pe_memory_out.datapoint_memory_write_data.expect(3.U(16.W))
	    dut.io.load_pe_memory_out.datapoint_memory_write_address.expect(2.U(16.W))
    
	    dut.io.load_pe_memory_out.buffer_memory_write_enable.expect(false.B)
	    dut.io.load_pe_memory_out.buffer_memory_write_data.expect(0.U(16.W))
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(3.U(16.W))
	    ...
	    dut.io.load_pe_memory_in.buffer_memory_output.poke(4.U(16.W))
	    dut.io.load_pe_memory_in.interconnect_memory_output.poke(0.U(16.W))
...
//Outputs
	    ...
	    dut.io.load_pe_memory_out.datapoint_memory_write_enable.expect(true.B)
	    dut.io.load_pe_memory_out.datapoint_memory_write_data.expect(4.U(16.W))
	    dut.io.load_pe_memory_out.datapoint_memory_write_address.expect(3.U(16.W))
    
	    dut.io.load_pe_memory_out.buffer_memory_write_enable.expect(false.B)
	    dut.io.load_pe_memory_out.buffer_memory_write_data.expect(0.U(16.W))
	    dut.io.load_pe_memory_out.buffer_memory_write_address.expect(4.U(16.W))
	    ...
	    dut.io.load_pe_memory_in.buffer_memory_output.poke(5.U(16.W))
	    dut.io.load_pe_memory_in.interconnect_memory_output.poke(0.U(16.W))
...
//Outputs
	    dut.io.load_pe_memory_out.current_load_datapoint_state.expect(2.U(16.W))
    	    dut.io.load_pe_memory_out.current_load_weights_state.expect(0.U(16.W))
