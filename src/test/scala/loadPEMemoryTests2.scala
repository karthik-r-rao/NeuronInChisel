...
class LoadPEMemorySpec2 extends AnyFlatSpec with ChiselScalatestTester{
...
//Inputs
            dut.io.load_pe_memory_in.load_initial_weights.poke(false.B)
            dut.io.load_pe_memory_in.load_datapoint.poke(true.B)
            dut.io.load_pe_memory_in.load_new_request.poke(true.B)
            dut.io.load_pe_memory_in.load_data_from_buffer.poke(false.B)
            dut.io.load_pe_memory_in.load_same_data.poke(false.B)
...
//Outputs
    	    dut.io.load_pe_memory_out.load_new_data_request.expect(true.B)
	    ...
	    dut.clock.step()
            ...
            dut.io.load_pe_memory_in.new_datapoint_ready.poke(true.B)
